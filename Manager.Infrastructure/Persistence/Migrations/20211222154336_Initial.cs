        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasSN = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductStates_Warehouses_WarehouseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySQL:ValueGenerationStrategy", MySQLValueGenerationStrategy.IdentityColumn),
                    QuantityUsed = table.Column<float>(type: "float", nullable: false),
                    Description = table.Column<string>(type: "text", nullable: true),
                    SN = table.Column<string>(type: "text", nullable: true),
                    ProductStateId = table.Column<int>(type: "int", nullable: true),
                    ProjectId = table.Column<int>(type: "int", nullable: true),
                    Employed1Id = table.Column<int>(type: "int", nullable: true),
                    Employed2Id = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectTasks_ProductStates_ProductStateId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectTasks_Users_Employed1Id",
                        column: x => x.Employed1Id,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectTasks_Users_Employed2Id",
                        column: x => x.Employed2Id,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductStates_WarehouseId",
                table: "ProductStates",
                column: "WarehouseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTasks_Employed1Id",
                table: "ProjectTasks",
                column: "Employed1Id");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectTasks_Employed2Id",
                table: "ProjectTasks",
                column: "Employed2Id");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectTasks_ProductStateId",
                table: "ProjectTasks",
