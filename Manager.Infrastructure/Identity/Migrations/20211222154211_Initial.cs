...
namespace Manager.Infrastructure.Identity.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityAppUserId = table.Column<string>(type: "varchar(85)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RefreshTokens_AspNetUsers_IdentityAppUserId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "dbb801d2-5671-4d58-9ad4-53d1506b64f9", "6605ccb0-2182-4e80-8e18-5b2bdfb6ccc7", "User", "USER" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "98334449-4467-43a8-a2bc-464f069dd1c2", "1dd28fe2-2dd2-4a00-abd5-c34c8265e4ef", "Admin", "ADMIN" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokens_IdentityAppUserId",
                table: "RefreshTokens",
                column: "IdentityAppUserId");
        }
